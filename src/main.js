...
const componentMap = {
	...
	'am-data-table': () => import('./components/AmDataTable.vue'),
	'am-schedule': () => import('./components/AmSchedule.vue'),
	'am-multiple-file-upload': () => import('./components/AmMultipleFileUpload.vue'),
	'am-autocomplete': () => import('./components/AmAutocomplete.vue'),
};
